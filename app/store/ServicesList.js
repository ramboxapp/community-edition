Ext.define('Rambox.store.ServicesList', {
    ...
    data: [{
        ...
        {
            id: 'planetromeo',
            logo: 'planetromeo.png',
            name: 'PlanetRomeo',
            description: 'PlanetRomeo is a international social network for gay, bisexual and transgender people.',
            url: 'https://www.planetromeo.com/#/module/messages',
            type: 'messaging'
        }
    ]
});