Ext.define('Rambox.store.ServicesList', {
	...
	,data: [
		...
		},
		{
			...
			,type: 'email'
			,allow_popups: true
			,js_unread: 'function checkUnread(){var a=document.getElementsByClassName("aim")[0];updateBadge(parseInt(a.textContent.replace(/[^0-9]/g,"")))}function updateBadge(a){a>=1?rambox.setUnreadCount(a):rambox.clearUnreadCount()}setInterval(checkUnread,3e3);'
