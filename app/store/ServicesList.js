Ext.define('Rambox.store.ServicesList', {
	...
	,data: [
		...
		},
		{
			...
			,type: 'messaging'
			,userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.2883.87 Safari/537.36 Edge/12.246'
			,js_unread: 'function checkUnread() { updateBadge(angular.element(document.documentElement).controller().pageTitleNotificationCount);}function updateBadge(e){e>=1?rambox.setUnreadCount(e):rambox.clearUnreadCount()}setInterval(checkUnread,3000);'
		},
		{
			 id: 'kezmo'
			,logo: 'kezmo.png'
